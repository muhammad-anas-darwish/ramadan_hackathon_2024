      ...
      <div v-for="card in cardsData" :key="card.id" class="w-full border rounded-lg shadow bg-gray-800 border-gray-700">
        ...
        <div class="px-5 pb-5">
          ...
          <div class="mt-2.5 mb-2.5 break-words text-xl text-gray-400">
             <RouterLink class="py-2 px-3 rounded md:p-0 hover:text-blue-500 hover:bg-gray-700 hover:bg-transparent" :to="{ name: 'Profile', params: { id: card.user.id } }">
              مالك المنتج
            </RouterLink>
          </div>
          <div class="mt-2.5 mb-2.5 break-words text-xl text-gray-400">أيام {{ card.days }}</div>
