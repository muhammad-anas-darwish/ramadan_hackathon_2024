...
<template>
  <article>
    <form @submit.prevent="submit" class="max-w-sm mx-auto">
      ...
      <div class="mb-5">
        <RouterLink class="ms-2 text-sm font-medium hover:underline text-blue-500" :to="{ name: 'Login' }">تسجيل الدخول</RouterLink>
      </div>
      <button type="submit" class="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">إرسال</button>
    </form>
  </article>
</template>
